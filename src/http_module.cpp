...
char* setClientCertificate(ngx_conf_t* cf, ngx_command_t* cmd, void* conf);
char* setClientKey(ngx_conf_t* cf, ngx_command_t* cmd, void* conf);
...
ngx_command_t gExporterCommands[] = {
    ...
    { ngx_string("client_certificate"),
      NGX_CONF_TAKE1,
      setClientCertificate },

    { ngx_string("client_key"),
      NGX_CONF_TAKE1,
      setClientKey },
